...
SECRET_KEY = 'django-insecure-2@@c)f_hipcz6!#y!y(3t!j5(4qmm7_#9)#fzb2vs(k$lzt*z!'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'movie/templates'), os.path.join(BASE_DIR, 'moviereviews/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
